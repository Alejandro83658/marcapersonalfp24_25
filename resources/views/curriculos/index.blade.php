...
<div class="row">
    ...
    <div class="col-4 col-md-6 col-12-small">
        <section class="box">
            ...
            <p>
                <strong>Skills: </strong>{{ $curriculo['texto_curriculum'] }}
            </p>
            <footer>
                <ul class="actions">
                    <li><a href="{{ action([App\Http\Controllers\CurriculoController::class, 'getShow'], ['id' => $key] ) }}" class="button alt">Más info</a></li>
                </ul>
            </footer>
        </section>
    </div>
